...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "stu_jhipster@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "stu_jhipster API";

        private String description = "stu_jhipster API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "stu_jhipster";
